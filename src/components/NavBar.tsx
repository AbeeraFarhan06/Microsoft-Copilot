...
import KittyKat from '../assets/KittyKat.png';
...
const Navbar = () => {
  ...
  return (
    <Box px={0} py={1} position="sticky" zIndex={1000} pt="2px" bg="white" mb={7}>
          ...
          <Box px="73px">
            <Flex h={12} alignItems="center" justifyContent="space-between">
              <HStack spacing={5} align="center">
                ...
                <Text fontSize="lg" fontWeight="semibold" mt="3px">Copilot</Text>
              ...
              <HStack spacing="10px" align="center">
                <MegaMenu />
                <IconButton color="black" aria-label="Search" icon={<VscSearch />} size="sm" />
                <IconButton color="black" aria-label="Cart" icon={<BsCart3 />} size="sm" />
                <Avatar size="sm" src={KittyKat} cursor="pointer" />
              </HStack>
            </Flex>
          </Box>
        ) : (
          ...
          <>
            ...
            <Box borderBottom="1px solid" borderColor="gray.200" pb={3} w="100%">
              <Flex justify="space-between" align="center" position="relative" px={4}>
                <HStack spacing={2}>
                  <IconButton icon={<HamburgerIcon />} aria-label="Open menu" onClick={onOpen} color="black" />
                  <IconButton icon={<VscSearch />} aria-label="Search" color="black" />
                </HStack>
                <Box position="absolute" left="50%" transform="translateX(-50%)">
                  <Image src={microsoft_logo} h="24px" w="107px" cursor="pointer" />
                </Box>
                <HStack spacing={2}>
                  <IconButton icon={<BsCart3 />} aria-label="Cart" color="black" />
                  <Avatar size="sm" src={KittyKat} cursor="pointer" />
                </HStack>
              </Flex>
            </Box>
                ...
                <Menu isLazy matchWidth>
                  {({ isOpen }) => (
                    <>
                      ...
                      >
                        Copilot <ChevronDownIcon transform={isOpen ? 'rotate(180deg)' : 'none'} transition="transform 0.2s" />
                      </MenuButton>
